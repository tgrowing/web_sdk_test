  ...
  return (function(e) {
              ...
              function(e, t, n) {
                ...
                (t.exports = c),
                  ...
                  (c.all = function(e) {
                    ...
                    for (
                      var a = new Array(n), s = 0, u = -1, c = new this(o);
                      ++u < n;
                  ...
                  (c.race = function(e) {
                    ...
                    var n = e.length,
                      r = !1;
                    if (!n) return this.resolve([]);
                    for (var a, s = -1, u = new this(o); ++s < n; )
                      (a = e[s]),
                        t.resolve(a).then(
                          function(e) {
                            r || ((r = !0), i.resolve(u, e));
            ...
            4: [
              function(e, t, n) {
                      ...
                      return a
                        ...
                        .then(function() {
                          if (
                            ...
                            return e.db && (e.version = e.db.version + 1), b(e);
                        })
                        .then(function() {
                          return (function(e) {
                            v(e);
                ...
                var x = {
                    ...
                    _initStorage: function(e) {
                      ...
                      o ||
                        ...
                        o.forages.push(t),
                        t._initReady ||
                          ((t._initReady = t.ready), (t.ready = T));
                      var i = [];
                      function s() {
                        return a.resolve();
                      }
                      ...
                      return a
                        ...
                        .then(function(e) {
                          return (
                            (n.db = e),
                            S(n, t._defaultConfig.version) ? b(n) : e
                          );
                        })
                        .then(function(e) {
                    ...
                    iterate: function(e, t) {
                      var n = this,
                        r = new a(function(t, r) {
                          n.ready()
                            .then(function() {
                              A(n._dbInfo, "readonly", function(o, i) {
                                if (o) return r(o);
                                try {
                                  var a = i
                    ...
                    setItem: function(e, t, n) {
                      ...
                      var o = new a(function(n, o) {
                        ...
                        r.ready()
                          ...
                          .then(function(t) {
                            A(r._dbInfo, "readwrite", function(i, a) {
                              if (i) return o(i);
                              try {
                    ...
                    removeItem: function(e, t) {
                      ...
                      var r = new a(function(t, r) {
                        n.ready()
                          .then(function() {
                            A(n._dbInfo, "readwrite", function(o, i) {
                              if (o) return r(o);
                              try {
                                var a = i
                                  .objectStore(n._dbInfo.storeName)
                    ...
                    clear: function(e) {
                      var t = this,
                        n = new a(function(e, n) {
                          t.ready()
                            .then(function() {
                              A(t._dbInfo, "readwrite", function(r, o) {
                                if (r) return n(r);
                                try {
                                  var i = o
                    ...
                    length: function(e) {
                      var t = this,
                        n = new a(function(e, n) {
                          t.ready()
                            .then(function() {
                              A(t._dbInfo, "readonly", function(r, o) {
                                if (r) return n(r);
                                try {
                                  var i = o
                                    .objectStore(t._dbInfo.storeName)
                ...
                var V = {
                  ...
                  W = {},
                  X = {},
                  q = { INDEXEDDB: x, WEBSQL: F, LOCALSTORAGE: V },
                  K = [
                    q.INDEXEDDB._driver,
                    q.WEBSQL._driver,
                ...
                var ee = new ((function() {
                  function e(t) {
                    ...
                    (this._defaultConfig = $({}, Y)),
                      (this._config = $({}, this._defaultConfig, t)),
                  ...
                  return (
                      ...
                      var r = new a(function(t, n) {
                        try {
                          ...
                          for (
                            ...
                            var l = i[u];
                            if ((!H(J, l) || e[l]) && "function" != typeof e[l])
                              return void n(o);
                          }
                          !(function() {
                            for (
                    ...
                    (e.prototype._wrapLibraryMethodsWithReady = function() {
                      for (var e = 0, t = Q.length; e < t; e++) Z(this, Q[e]);
                    }),
        ...
        var e = function(e, t) {
            ...
            return (
              ...
              ((r.indexOf("linux") >= 0 ||
                ...
                ((r.indexOf("mac") >= 0 ||
                  ...
                  "Mac" !== e &&
                  "iOS" !== e) ||
                  (!(r.indexOf("arm") >= 0 && "Windows Phone" === e) &&
                    !(r.indexOf("pike") >= 0 && t.indexOf("opera mini") >= 0) &&
                      ((r.indexOf("win") < 0 &&
                        r.indexOf("linux") < 0 &&
                        r.indexOf("mac") < 0 &&
                        r.indexOf("iphone") < 0 &&
          ...
          G = [
            ...
            },
            {
              key: "plugins",
              getData: function(e, t) {
                P() ? (t.plugins.excludeIE ? e(t.EXCLUDED) : e(h(t))) : e(p(t));
              },
            },
            {
              key: "canvas",
              getData: function(e, t) {
                N() ? e(T(t)) : e(t.NOT_AVAILABLE);
              },
            },
            {
              key: "webgl",
            ...
            },
            {
              ...
              getData: function(e, t) {
                ...
                for (var p = 0, h = n.length; p < h; p++)
                  (s[n[p]] = d[p].offsetWidth), (u[n[p]] = d[p].offsetHeight);
                var v = (function() {
                ...
                o.appendChild(a);
                for (var g = [], m = 0, w = r.length; m < w; m++)
                  f(v[r[m]]) && g.push(r[m]);
              ...
              V.get(e, function(n) {
                for (var r = [], o = 0; o < n.length; o++) {
                  ...
                  if (i.value === (e.NOT_AVAILABLE || "not available"))
                    r.push({ key: i.key, value: "unknown" });
                    ...
                    r.push({ key: i.key, value: i.value.join("~") });
                  else if (
                    -1 !==
                    [
                      "sessionStorage",
                    ...
                    i.value
                      ...
                      : r.push({ key: i.key, value: i.value });
                }
                var s = a(
                  c(r, function(e) {
                    return e.value;
    ...
    function(e, t, n) {
      ...
      var r = n(1),
        ...
        a = (function() {
          function e(e) {
            var t = this;
            (this.lifeCycle = new r.a()),
              (this.uploadJobQueue = []),
              (this._normalLogPipeline = Object(o.a)([
                function(e) {
                  t.send(
                    {
                      url: t.baseInfo.url,
                    ...
                    function() {
                      ...
                      "function" == typeof n &&
                        n(JSON.stringify(e.msgs[0].data.events));
                    },
                    function() {
              ...
              Object(r.b)(Boolean(e.appkey), "appkey must be initial"),
              (this.baseInfo = i(
                { initTime: Date.now().toString(), language: "zh-CN" },
                e
              ));
          }
          return (
            (e.prototype.getCommonInfo = function() {
              ...
              return {
                deviceId:
                  null === (e = this.baseInfo) || void 0 === e
                    ? void 0
                    : e.deviceId,
                appkey:
                  null === (t = this.baseInfo) || void 0 === t
                    ? void 0
                    : t.appkey,
                versionCode:
                  null === (n = this.baseInfo) || void 0 === n
                    ? void 0
                    : n.versionCode,
                initTime:
                  null === (r = this.baseInfo) || void 0 === r
                    ? void 0
                    : r.initTime,
                channelID:
                  null === (o = this.baseInfo) || void 0 === o
                    ? void 0
                    : o.channelID,
                sdkVersion:
                  null === (i = this.baseInfo) || void 0 === i
                    ? void 0
                    : i.sdkVersion,
                pixel:
                  null === (a = this.baseInfo) || void 0 === a
                    ? void 0
                    : a.pixel,
                language:
                  null === (s = this.baseInfo) || void 0 === s
                    ? void 0
                    : s.language,
              };
            }),
    ...
    function(e, t, n) {
      ...
      !(function(o, i) {
        ...
        var a = "model",
          ...
          m = {
            browser: [
              ...
              [s, [l, v.str, g.browser.oldsafari.version]],
              [/(webkit|khtml)\/([\w\.]+)/i],
              [s, l],
            ...
            os: [
              ...
              [s, [l, v.str, g.os.windows.version]],
              [/(win(?=3|9|n)|win\s9x\s)([nt\d\.]+)/i],
              [
                [s, "Windows"],
                [l, v.str, g.os.windows.version],
              ],
              [/\((bb)(10);/i],
              [[s, "BlackBerry"], l],
              [
          ...
          w = function(e, t) {
            ...
            return (
              (this.getBrowser = function() {
                ...
                return (
                  v.rgx.call(e, n, r.browser), (e.major = h.major(e.version)), e
                );
              }),
        ...
        (w.VERSION = "0.7.24"),
          (w.BROWSER = { NAME: s, MAJOR: "major", VERSION: l }),
          ...
          (w.ENGINE = { NAME: s, VERSION: l }),
          (w.OS = { NAME: s, VERSION: l }),
          void 0 !== t
            ? (void 0 !== e && e.exports && (t = e.exports = w),
              (t.UAParser = w))
            : void 0 ===
                (r = function() {
                  return w;
    ...
    function(e, t, n) {
      ...
      function u() {
        return -1 != location.href.indexOf("?")
          ? location.search || "?" + location.href.split("?")[1]
          : location.search;
      }
      function c(e) {
        return null == e;
      ...
      function p() {
        return !!navigator.userAgent.match(/isApp/i);
      }
      function h() {
        var e = navigator.userAgent;
        return e.match(/miniprogram/i) ||
          "miniprogram" === window.__wxjs_environment
          ? "Weapp"
          : e.match(/Android|Adr/i)
          ? "Android"
      ...
      function v(e) {
        return e + "_session_end_info";
      }
      function g(e) {
        return e + "_last_report_time";
      }
      function m(e) {
        return e + "_last_event_trigger_time";
      }
      function w(e) {
        return e + "_is_new_user";
      }
      function y(e) {
        return e + "_session_storage_key";
      }
      function b(e) {
        return e + "_page_visit";
      }
      function S(e) {
        return e + "_beacon_weapp";
      }
      var _ = ["h5_pv_end", "h5_session_start", "h5_session_end"],
        E = ["h5_session_end"],
        T = ["h5_init", "h5_pv", "h5_session_start", "h5_session_end"],
        A = function() {
          return (A =
            Object.assign ||
            function(e) {
      ...
      var N = n(2),
        ...
        M = (function() {
          function e(e) {
            ...
            (n =
              t > 8 && t < 10
                ? [R.a.LOCALSTORAGE]
                : [R.a.INDEXEDDB, R.a.WEBSQL, R.a.LOCALSTORAGE]),
              (this.store = R.a.createInstance({
                driver: n,
                name: "Beacon" + e,
                version: 1,
                size: 4980736,
          ...
          return (
            (e.prototype.concatEvents = function(e) {
              (this.jobQueue = this.jobQueue.concat(e)),
                this.realStore(this.jobQueue.shift());
            }),
            (e.prototype.realStore = function(e) {
              var t = this;
              if (e) {
                var n = e.params,
                  r = n.A99.toString() + n.A100.toString();
                this.store.setItem(r, e).then(function() {
                  t.realStore(t.jobQueue.shift());
                });
              }
            }),
        ...
        j = [
          { name: "push", apiName: "pushState" },
          { name: "replace", apiName: "replaceState" },
          { name: "pop", apiName: "popState" },
        ];
      function F(e) {
        return f(i(b(e)), ["start", "ref", "cur"]);
      }
      function U(e) {
        return f(i(S(e)), ["uin", "uid", "is_first"]);
      }
      function G() {
        var e = location.href.indexOf("?");
        return -1 != e ? location.href.substring(0, e) : location.href;
      }
      function V(e) {
        var t = { start: Date.now(), ref: document.referrer, cur: G() };
        o(b(e), JSON.stringify(t));
      }
      function H(e) {
        var t,
          n,
          ...
          i = {
            uin: r.beacon_uin,
            uid: r.beacon_uid,
            is_first: "Y" === r.beacon_is_first ? "Y" : "N",
          };
        o(S(e), JSON.stringify(i));
      }
      function z(e, t) {
        te.beacon
          ? te.beacon.onDirectUserAction(e, t || {})
          : console.error(
              "Error! BeaconAction must be initialized before page loading."
            );
      }
      function W(e) {
        window.addEventListener(
          ...
          function() {
            V(e),
              H(e),
              "hidden" !== document.visibilityState && z("h5_pv_start");
          },
          { capture: !0 }
        ),
          window.addEventListener(
            ...
            function(t) {
              "hidden" === document.visibilityState
                ...
                : (!(function(e) {
                    var t = F(e);
                    if (t) {
                      var n = { start: Date.now(), cur: G(), ref: t.ref };
                      o(b(e), JSON.stringify(n));
                    } else V(e);
                  })(e),
                  H(e),
                  z("h5_pv_start"));
          ...
          window.addEventListener(
            ...
            function(t) {
              ...
              z("h5_pv_end"),
                setTimeout(function() {
                  var t = { start: Date.now(), ref: n.prevUrl, cur: G() };
                  o(b(e), JSON.stringify(t)), H(e), z("h5_pv_start");
                }, 0);
            },
            { capture: !0 }
          );
      ...
      function X(e) {
        e
          ? (!(function() {
              window.addEventListener(
                ...
                function(e) {
                  ...
                  window.dispatchEvent(
                    new CustomEvent("tgp-page-change", { detail: t })
                  );
                },
                { capture: !0 }
              );
                    ...
                    window.history[n] =
                      ...
                      function() {
                        for (var e = [], n = 0; n < arguments.length; n++)
                          e[n] = arguments[n];
                        var o = location.href,
                          i = t.bind.apply(t, L([this], e))(),
                          a = { type: "history", name: r, prevUrl: o };
                        return (
                          window.dispatchEvent(
                            new CustomEvent("tgp-page-change", { detail: a })
                          ),
                          i
                        );
                      });
            ...
            W(e))
          : console.error(
              "Error! Process ends cause by 'Invalid AppKey'. Please call Beacon constructor first."
            );
      }
      var q = n(18),
        K = n.n(q),
        J = (function() {
          function e() {
            var e = new K.a(navigator.userAgent, "");
            this.userAgentObj = e.getResult();
          }
          return (
            (e.prototype.getBrowser = function() {
              return this.userAgentObj.browser;
            }),
            (e.prototype.getDevice = function() {
              return this.userAgentObj.device;
            }),
            (e.prototype.getOS = function() {
              return this.userAgentObj.os;
            }),
            (e.prototype.getDeviceType = function() {
              var e = this.getDevice().type;
              return e || "pc";
            }),
            (e.prototype.getScreenPixel = function() {
              var e = screen.width,
                t = screen.height;
              if (e && t) return e + "*" + t;
            }),
            (e.prototype.getNetworkType = function() {
              ...
              return null == e ? void 0 : e.effectiveType;
            }),
        ...
        Q = (function() {
          function e() {
            (this.isApp = p()), (this.env = h());
          }
          return (
            (e.prototype.sendMsg = function(e, t, n, r) {
              var o = { cmd: e };
              t && (o.data = t),
                r && (o.callback = r),
                (o.callId = n || Number(Date.now()).toString(36) + "_" + e),
                this.isApp && "other" !== this.env
                  ? "IOS" === this.env
                    ? window.webkit &&
                      window.webkit.messageHandlers &&
                      window.webkit.messageHandlers.tgpJsBridge
                      ? window.webkit.messageHandlers.tgpJsBridge.postMessage(o)
                      : console.error("IOS APP 尚未支持")
                    : "Android" === this.env &&
                      console.error("tgpJsBridge://" + JSON.stringify(o))
                  : console.error("非指定APP环境，不做数据上报");
            }),
            (e.prototype.dataSend = function(e, t) {
              return this.sendMsg(
                "nativeReport",
                e,
                t,
                "__beacon_nativeReportResponse"
              );
            }),
            e
          );
        })();
      window.__beacon_nativeReportResponse = function(e) {
        var t,
          n,
          r,
          o = e.retCode,
          i = e.callId;
        0 === o
          ? (((r = document.createElement("div")).innerText =
              i + " 数据上报成功"),
            null === (t = document.getElementById("suc")) ||
              void 0 === t ||
              t.appendChild(r))
          : (((r = document.createElement("div")).innerText =
              i + " " + e.errMsg),
            null === (n = document.getElementById("fail")) ||
              void 0 === n ||
              n.appendChild(r));
      };
      var Y,
          ...
          function t(n) {
            ...
            if (
              ((r.send = function(e, t, n) {
                var i;
                if (!r.baseInfo.url || !r.baseInfo.appkey)
                  throw new Error("please call init before");
                var a = function(n) {
                  "function" == typeof t && t(e.data),
                    r.removeSendingIds(e),
                    r.store.cleanEvents(e.data.msgs[0].data.events);
                };
                o(g(r.baseInfo.appkey), Date.now().toString());
                var s = (
                  (null === (i = null == e ? void 0 : e.data) || void 0 === i
                    ? void 0
                    : i.msgs.reduce(function(e, t) {
                        var n,
                          r =
                ...
                if (
                  s.length > 0 &&
                  s.some(function(e) {
                    return r.eventsNeedSendBeacon.has(e);
                  }) &&
                ...
                I.a
                  .post(r.baseInfo.url, e.data)
                  .then(a)
                  .catch(function(t) {
                    "function" == typeof n && n(e.data),
                      r.removeSendingIds(e),
                      r.store.concatEvents(e.data.msgs[0].data.events);
                  });
              }),
              !n.reportUrl)
            )
              return console.error("TGP SDK Error: ReportURL is required."), r;
            (r.baseInfo.url = n.reportUrl), X(n.appkey);
            var a = s();
            if (((r.isUnderIE8 = a > 0 && a < 8), r.isUnderIE8)) return r;
            (r.store = new M(n.appkey)),
              (r.bridge = new Q()),
              (r.additionalParams = {}),
              (r.sendingEvents = {}),
              (r.baseInfo.deviceId = i("deviceId")),
              (r.userAgentString = navigator.userAgent),
              (r.deviceInfoCollector = new J()),
              r.initCommonInfo(n),
              (t.beacon = r);
            var u = (function(e, t) {
              var n = y(e);
              function r(t) {
                ...
                return (
                  ...
                  setTimeout(function() {
                    o(g(e), Date.now().toString()),
                      te.beacon.onDirectUserAction("h5_session_start", {});
                  }, 0),
                  r
                );
              }
              function a() {
                ...
                if (t && r) {
                  var a = A(A({}, r), { time: t });
                  o(v(e), JSON.stringify(a)),
                    setTimeout(function() {
                      te.beacon.onDirectUserAction("h5_session_end", {}),
                        Promise.resolve(w(e)).then(function(e) {
                          return o(e, JSON.stringify(!1));
                        });
                    }, 0);
                }
              }
              var s = function(e) {
                return f(e, ["sessionId", "sessionStart"]);
              };
              return {
                getSession: function(e) {
                  var o = Date.now(),
                    u = Promise.resolve(i(n));
                  return u.then(function(n) {
                    var u = s(n);
                    if (!u) return Promise.resolve(r(o));
                    var c = Number(i(g(e)));
                    return t < o - c
                      ? (a(), Promise.resolve(r(o)))
                      : Promise.resolve({
                ...
                getValidSession: s,
                getSessionEndInfo: function(e) {
                  return f(i(v(e)), ["time", "sessionId", "sessionStart"]);
                },
              };
            })(
              n.appkey,
              n.sessionDuration
                ? n.sessionDuration < 5e3
                  ? 5e3
                  : n.sessionDuration
                : 18e5
            );
            return (
              (r.getSession = u.getSession),
              (r.getValidSession = u.getValidSession),
              (r.getSessionEndInfo = u.getSessionEndInfo),
              r.onDirectUserAction("h5_init", {}),
              setTimeout(function() {
                return r.lifeCycle.emit("init");
              }, 0),
              r.sendStoreEvents(),
              r.inApp || r.cycleSend(n.delay ? n.delay : 3e3),
              r
            );
          }
          return (
            Z(t, e),
            (t.prototype.initCommonInfo = function(e) {
              if (
                ((this.baseInfo.sdkVersion = "4.0.2"),
                (this.baseInfo.url =
                  "http://oth.eve.mdt.qq.com:8080/analytics/upload?tp=js"),
                "https:" === location.protocol &&
                  (this.baseInfo.url =
                    "https://otheve.beacon.qq.com/analytics/upload?tp=js"),
                (this.baseInfo.url = e.reportUrl),
                e.strictMode && (this.strictMode = e.strictMode),
                e.jsBridge && (this.jsBridge = e.jsBridge),
                e.weappAppkey && (this.weappAppkey = e.weappAppkey),
                this.jsBridge)
              ) {
                var t = h();
                (this.inWeapp = "Weapp" === t),
                  (this.inApp = p() && ["IOS", "Android"].includes(t));
              }
              (this.eventsNeedLastReportPatch = new Set(E)),
                (this.eventsNeedSendBeacon = new Set(_)),
                (this.baseInfo.language =
                  (navigator && navigator.language) || "zh_cn");
              var n = [window.screen.width, window.screen.height];
              window.devicePixelRatio && n.push(window.devicePixelRatio),
                (this.baseInfo.pixel = n.join("*"));
              var r = (function(e) {
                try {
                  return (
                    (e = "__BEACON_" + e), window.sessionStorage.getItem(e)
                  );
                } catch (e) {
                  return "";
                }
              })("initTime");
              if (r) this.baseInfo.initTime = r;
              else {
                var o = Date.now().toString();
                (this.baseInfo.initTime = o),
                  (function(e, t) {
                    try {
                      (e = "__BEACON_" + e),
            ...
            (t.prototype.sendStoreEvents = function() {
              var e,
                t = this;
              null === (e = this.store.getEvents()) ||
                void 0 === e ||
                e.then(function(e) {
                  var n = [];
                  if (e && e.length > 0) {
                    if (
                      (e.forEach(function(e) {
                        var r = e.params,
                          o = r.A99.toString() + r.A100.toString();
                        t.sendingEvents.hasOwnProperty(o) ||
                          (n.push(e), (t.sendingEvents[o] = e));
                      }),
                      n.length <= 0)
                    )
                      return;
            ...
            (t.prototype.cycleSend = function(e) {
              var t = this;
              setTimeout(function() {
                t.sendStoreEvents(), t.cycleSend(e);
              }, e);
            }),
              ...
              this.isUnderIE8 ||
                (this.baseInfo.deviceId
                  ...
                  : (function(e) {
                        ...
                        return k(this, function(t) {
                          return [
                            ...
                            new Promise(function(t) {
                              O.a.get(e, function(e) {
                                var n = e.map(function(e) {
                                    return e.value;
                                  }),
                                  r = O.a.x64hash128(n.join(""), 31);
                                t(r);
                              });
                            }),
                          ];
                    ...
                    })({ screen_resolution: !0 }).then(function(i) {
                      (r.baseInfo.deviceId = i.replace(/\.|\+|\(|\)/g, "")),
                        o("deviceId", r.baseInfo.deviceId),
                        r.onReport(e, t, n);
                    }));
            }),
            (t.prototype.onReport = function(e, t, n) {
              var r, a;
              (a = n
                ? this.baseInfo.appkey + "_direct_log_id"
                : (function(e) {
                    return e + "_normal_log_id";
                  })(this.baseInfo.appkey)),
                (r = (r = Number(i(a))) || 1);
              var s = Date.now(),
                f = this.getCurPageVisitInfo(this.baseInfo.appkey),
                d = f.pageInterval,
                p = f.pageReferrer,
                h = f.currentPage,
                v = $($($({}, this.additionalParams), t), {
                  event_time: s,
                  source: p,
                  page_path: h,
                  path_parameter: u(),
                  view_duration: c(d) ? "0.0" : l(d),
                }),
                g = this.renameEvent(e);
              this.inApp
                ? this.handleReportForApp(g, v, n, r)
                : this.inWeapp
                ? this.handleReportForWeapp(g, v, n, r)
                : this.handleReportForWeb(g, v, n, r),
                o(a, (++r).toString());
            }),
            (t.prototype.handleReportForWeb = function(e, t, n, r) {
              var o,
                i,
                a,
                s,
                u,
                c = this.deviceInfoCollector.getOS(),
                l = c ? c.name + " " + c.version : "",
                f = {};
              this.inWeapp ||
                (f = {
                  uid: this.baseInfo.openid,
                  isNewUser: this.getIsNewUser(this.baseInfo.appkey),
                }),
                (t = $($($({}, t), f), {
                  device_type: this.deviceInfoCollector.getDeviceType(),
                  screen_resolution: this.deviceInfoCollector.getScreenPixel(),
                  os_version: l,
                  browser_type:
                    null === (o = this.deviceInfoCollector.getBrowser()) ||
                    void 0 === o
                      ? void 0
                      : o.name,
                  browser_version:
                    null === (i = this.deviceInfoCollector.getBrowser()) ||
                    void 0 === i
                      ? void 0
                      : i.version,
                  browser_language: this.deviceInfoCollector.getLanguage(),
                  brand:
                    null === (a = this.deviceInfoCollector.getDevice()) ||
                    void 0 === a
                      ? void 0
                      : a.vendor,
                  channel: this.baseInfo.channelID,
                  model:
                    null === (s = this.deviceInfoCollector.getDevice()) ||
                    void 0 === s
                      ? void 0
                      : s.model,
                  A99: n ? "Y" : "N",
                  A100: r,
                  os:
                    null === (u = this.deviceInfoCollector.getOS()) ||
                    void 0 === u
                      ? void 0
                      : u.name,
                }));
              ...
              d.push({
                ...
                n ? this.realSend(d) : this.store.concatEvents(d);
            }),
            (t.prototype.handleReportForWeapp = function(e, t, n, r) {
              if (this.weappAppkey && !T.includes(e)) {
                var o = U(this.baseInfo.appkey);
                o && o.uid
                  ? ((t = $($({}, t), { uid: o.uid, is_first: o.is_first })),
                    this.handleReportForWeb(e, t, n, r))
                  : console.error("获取用户标识失败，不做数据上报");
              }
            }),
            (t.prototype.handleReportForApp = function(e, t, n, r) {
              if (!T.includes(e)) {
                var o = this.baseInfo.appkey + "_" + (n ? "Y" : "N") + r,
                  i = {
                    eventCode: e,
                    eventType: n ? 1 : 0,
                    params: $($({}, t), { platform: "H5", A72: "4.0.2" }),
                  };
                this.bridge.dataSend(i, o);
              }
            }),
            (t.prototype.renameEvent = function(e) {
              var t = e;
              return (
                this.inWeapp
                  ? "h5_pv_start" === e
                    ? (t = "weapp_pv")
                    : "h5_pv_end" === e && (t = "weapp_unpv")
                  : this.inApp &&
                    ("h5_pv_start" === e
                      ? (t = "pageview")
                      : "h5_pv_end" === e && (t = "unpageview")),
                t
              );
            }),
            (t.prototype.replace = function(e) {
              for (var t = {}, n = 0, r = Object.keys(e); n < r.length; n++) {
                var o = r[n],
                  i = e[o];
                if (c(i) || "" === i) t[a(o)] = "undefined";
                else if ("string" == typeof i || "number" == typeof i)
                  t[a(o)] = a(i);
                else {
                  if (this.strictMode)
                    throw new Error("value mast be string or number !!!!");
                  t[a(String(o))] = a(String(i));
                }
              }
              return t;
            }),
            (t.prototype.removeSendingIds = function(e) {
              var t = this,
                n = e.data.msgs[0].data.events;
              n &&
                n.forEach(function(e) {
                  var n = e.params,
                    r = n.A99.toString() + n.A100.toString();
                  t.sendingEvents.hasOwnProperty(r) &&
                    delete t.sendingEvents.eventId;
                });
            }),
            (t.prototype.realSend = function(e) {
              var t = this;
              if (
                ((this.session$ = this.getSession(this.baseInfo.appkey)),
                !this.session$)
              )
                throw new Error("Error. Please call init before.");
              this.session$.then(function(n) {
                if (e && 0 != e.length) {
                  ...
                  o(m(t.baseInfo.appkey), r.toString());
                  var i = {
                      id: n.sessionId,
                  ...
                  a.push({
                    type: 2,
                    data: t.getPatchedData(i, t.baseInfo.appkey),
                  });
                  var s = $($({}, t.getCommonInfo()), {
                    platform: "H5",
                    msgs: a,
                  });
                  if (t.inWeapp) {
                    var u = U(t.baseInfo.appkey);
                    if (!u || !u.uin)
                      return void console.error(
                        "获取用户标识失败，不做数据上报"
                      );
                    (s.deviceId = u.uin),
                      (s.appkey = t.weappAppkey),
                      t._normalLogPipeline(s);
                  } else t._normalLogPipeline(s);
                } else console.info("Stop uploading. Caused by 'No events'.");
              });
            }),
            (t.prototype.getPatchedData = function(e, t) {
              var n = $({}, e),
                r = this.getSessionEndInfo(this.baseInfo.appkey),
                o = { sessionEnd: r, session: this.getValidSession(i(y(t))) },
                a = this.getPatchedEvents(e.events, o);
              return (
                1 === a.length &&
                  this.eventsNeedLastReportPatch.has(a[0].id) &&
                  r &&
                  ((n.id = r.sessionId), (n.start = r.sessionStart)),
                (n.events = a),
                n
              );
            }),
            (t.prototype.getPatchedEvents = function(e, t) {
              var n = this;
              return e.map(function(e) {
                var r = n.getSessionInterval(e, t);
                return $($({}, e), {
                  params: n.replace(
                    $($({}, e.params), { session_interval: r })
                  ),
                });
              });
            }),
            (t.prototype.getSessionInterval = function(e, t) {
              var n = e.id,
                r = e.params.event_time,
                o = t.session,
                i = t.sessionEnd;
              if (o) {
                var a = r - o.sessionStart;
                if (this.eventsNeedLastReportPatch.has(n))
                  if (i) a = i.time - i.sessionStart;
                return l(d(a));
              }
            }),
            (t.prototype.getCurPageVisitInfo = function(e) {
              var t = F(e);
              return t
                ? {
                    pageInterval: d(Date.now() - t.start),
                    pageReferrer: t.ref,
                    currentPage: t.cur,
                  }
                : {};
            }),
            (t.prototype.getIsNewUser = function(e) {
              return "false" !== i(w(e));
            }),
            (t.prototype.getAppKey = function() {
              return this.baseInfo.appkey;
            }),
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJ0Z3BfaDVfc2RrLm1pbi5qcyIsInNvdXJjZVJvb3QiOiIifQ==
